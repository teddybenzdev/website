      ...
      <footer className="bg-dark text-background rounded-t-[4rem] px-6 py-20 md:py-24 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="font-drama italic text-xl opacity-70">
            Buying land. Building the AI that vets it.
          </p>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-8 inline-flex items-center justify-center relative overflow-hidden group bg-accent text-background px-6 py-3 rounded-full font-sans font-bold text-sm tracking-wide hover:scale-[1.03] transition-transform duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] shadow-lg hover:shadow-accent/40"
          >
            <span className="absolute inset-0 w-full h-full -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] bg-primary/95 pointer-events-none rounded-full"></span>
            <span className="relative z-10 flex items-center gap-2">
              Get AI Audit <ArrowUpRight size={16} className="group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />
            </span>
          </a>
        </div>
